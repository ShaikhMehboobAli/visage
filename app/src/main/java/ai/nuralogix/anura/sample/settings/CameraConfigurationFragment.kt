...
class CameraConfigurationFragment: PreferenceFragmentCompat() {
    companion object {
        ...
        const val CAMERA_RESOLUTION = "cameraResolution"
    }
    ...
    private fun setupViews() {
        ...
        val cameraResolutionPref = findPreference((getString(R.string.pref_camera_check_resolution))) as CheckBoxPreference
        cameraResolutionPref.onPreferenceChangeListener = Preference.OnPreferenceChangeListener { preference, `object` ->
            cameraResolutionPref.isChecked = `object` as Boolean
            arguments?.putBoolean(CAMERA_RESOLUTION, cameraResolutionPref.isChecked)
